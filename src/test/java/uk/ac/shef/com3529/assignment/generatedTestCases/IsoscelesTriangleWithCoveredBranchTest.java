    ...
    static class TestArgumentsProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
            return Stream.of(
                    ...
                    Arguments.of(3, 3, 8, false, new HashSet<Integer>(Arrays.asList(6))), //Test ID 1: [false, false, true, false]
                    Arguments.of(7, 3, 5, false, new HashSet<Integer>(Arrays.asList(1, 5))), //Test ID 4: [true, false, false, false]
                    Arguments.of(4, 4, 2, true, new HashSet<Integer>(Arrays.asList(1, 2, 3))), //Test ID 5: [true, false, true, true]
                    Arguments.of(8, 1, 1, true, new HashSet<Integer>(Arrays.asList(1, 2, 3))) //Test ID 6: [true, true, false, true]
            );
        }
    }
